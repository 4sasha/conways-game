...
public class conways {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("First, you will choose how many generations you want to go through a life cycle");
        ...
        System.out.println();
        System.out.println("Sorry if that was a lot of information! Have fun!:) ");
        while (true) {
            System.out.println("Press L to load saved game or else press enter");
        ...
        while (true) {
            System.out.println("How many generations of life do you want to play for or enter for 1 generation?");
        ...
        while (true) {
            ...
            System.out.println("write in format (letter)(number), for example D7");
            ...
            if (cell1.length() == 0) { // if we have no value aka enter button was pressed we play the game
                ...
                if (Character.toString(cell1.toUpperCase().charAt(0)).matches("[A-Z]")) {
                    if (cell1.substring(1).matches("[0-9]+")) {
                        ...
                        if (cellX < 0 || cellX > XSIZE - 1 || cellY < 0 || cellY > YSIZE - 1) {
                            System.out.println("Invalid answer, out of bounds");
                        } else {
